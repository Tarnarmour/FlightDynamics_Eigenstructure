...
import sys
sys.path.append("..")
sys.path.append("C:\ProgramData\Anaconda3\Lib\site-packages\PySide2\plugins")
import numpy as np
...
class MavViewer():
    def __init__(self):
        ...
        self.window.setGeometry(0, 0, 910, 1080)  # args: upper_left_x, upper_right_y, width, height
    ...
    def update(self, state):
        ...
        # else update drawing on all other calls to update()
            ...
            if self.counter > simulation_parameters.drawing_update_period:
