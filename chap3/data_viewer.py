...
class DataViewer:
    def __init__(self, time_window_length=100):
        self.plotter = Plotter(update_period=SIM.data_plotting_period,  # update plots every x time steps
                               time_window=time_window_length)  # plot last time_window seconds of data

        self.sample_period = SIM.data_sample_period
